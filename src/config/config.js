...
module.exports = {
  ...
  marketman: {
    ...
    apiPassword: process.env.MARKETMAN_API_PASSWORD, // necesario para obtener token
    locationId: process.env.MARKETMAN_LOCATION_ID,
    // opcional: nombre de la locación que aparecerá en el payload
    locationName: process.env.MARKETMAN_LOCATION_NAME || ''
  },
